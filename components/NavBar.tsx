...
// // ... (previous menuItems, SteamAnimation, and CoffeeRipple components remain the same)
...
//       if (activeDropdown && !(e.target as Element).closest('[data-nav-item]')) {
